      ...
      L.marker([HOME_LAT, HOME_LNG], { icon: makeHomeIcon(L), zIndexOffset: 3000 })
        ...
        .bindPopup(`
          <div style="padding:13px 16px;min-width:170px">
            ...
            <div style="font-family:JetBrains Mono;font-size:13px;color:#5F3718;font-weight:600">Kalyan, Maharashtra</div>
            <div style="font-family:JetBrains Mono;font-size:9px;color:#73421A;margin-top:3px">India · 19.24°N 73.13°E</div>
